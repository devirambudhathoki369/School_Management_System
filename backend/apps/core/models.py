...
- Primary keys are UUIDv7, generated by PostgreSQL (requires PG >= 18).
...
class UUIDv7Field(models.UUIDField):
    """UUID primary key generated by PostgreSQL's native uuidv7()."""

    def __init__(self, **kwargs):
        kwargs.setdefault("primary_key", True)
        kwargs.setdefault("editable", False)
        kwargs.setdefault("db_default", models.Func(function="uuidv7"))
